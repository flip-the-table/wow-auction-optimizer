            ...
            {data && (
                <div className="data-table-wrapper fade-in" style={{ opacity: loading ? 0.6 : 1 }}>
                    <table className="data-table">
                        ...
                        <tbody>
                            {data.recipes.map((r: CraftRecipe) => {
                                ...
                                return (
                                    <React.Fragment key={r.recipe_id}>
                                        ...
                                        >
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={(e) => {
                                                            ...
                                                            setExpanded(prev => {
                                                                ...
                                                                if (next.has(r.recipe_id)) next.delete(r.recipe_id);
                                                                else next.add(r.recipe_id);
                                                                return next;
                                                            });
                                                        }}
                                                    >
                                            ...
                                            <td>
                                                <span
                                                    className={`stat-badge ${r.margin > 0 ? 'positive' : 'negative'}`}
                                                >
